...
ANACT_NETWORK_NOT_IMPLEMENTED = "ANACT_CONNECTOR_NETWORK_NOT_IMPLEMENTED"
ANACT_METADATA = ConnectorMetadata(
    "anact",
    "ANACT",
    "Agence nationale pour l'amélioration des conditions de travail",
    "Architecture documentaire hors ligne sans transport",
    ("working_conditions", "work_organization", "social_dialogue"),
)
ANACT_CAPABILITIES = frozenset({Capability.MANUAL})
ANACT_PLATFORM_CONTRACT = ConnectorContract(
    metadata=ANACT_METADATA,
...
ANACT_REGISTRY = ConnectorRegistry()
ANACT_REGISTRY.register(ANACT_PLATFORM_CONTRACT)
ANACT_HEALTH = HealthReport(
    HealthStatus.DISABLED,
    datetime(2026, 7, 17, tzinfo=timezone.utc),
    "architecture_only",
)
ANACT_STATISTICS = ConnectorStatistics()
ANACT_METRICS = (
...
def operation_not_implemented() -> ConnectorPlatformError:
    return ConnectorPlatformError(ErrorCode.NETWORK_DISABLED, ANACT_NETWORK_NOT_IMPLEMENTED)
